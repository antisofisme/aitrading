"""
Standard Configuration Manager untuk semua services
...
class StandardConfigManager:
    ...
    def __repr__(self) -> str:
        ...
        return f"StandardConfigManager(service_name='{self.service_name}', environment='{self.environment}', config_keys={list(self.config_data.keys())})"